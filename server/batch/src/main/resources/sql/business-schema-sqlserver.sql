...
CREATE INDEX IDX_BUS_NATNID_TITLE ON LOCAL_BUS (NATNID_REGNNUMB, CUST_TITL_LINE1);
CREATE INDEX IDX_BUS_NATNID_TITL_PKEY ON LOCAL_BUS (NATNID_REGNNUMB, CUST_TITL_LINE1, PKEY);
CREATE INDEX IDX_BUS_PKEY ON LOCAL_BUS (PKEY);
...
CREATE INDEX IDX_A11_HEADID_CNAME_ID ON A11 (CUSTHEADID, CUSTCNAME, CUSTID);
