...
public class SBF15AProcessor implements ItemProcessor<A41, List<A44>> {
    ...
    protected final Logger logger = LoggerFactory.getLogger(SBF15AProcessor.class);
    ...
    private List<A44> createA44s(A41 item, Guarantor guarantor) {
        List<A44> a44List = new ArrayList<A44>();
        Bus bus = null;
        if (guarantor.getUdf9() != null && (bus = busDao.findByCustNumb(guarantor.getUdf9())) != null) {
            A44 a44 = createA44(item);
            a44.setArantId(guarantor.getUdf9());
            a44.setArantName(bus.getCustTitlLine1());
        ...
        if (guarantor.getUdf15() != null && (bus = busDao.findByCustNumb(guarantor.getUdf15())) != null) {
            A44 a44 = createA44(item);
        ...
        if (guarantor.getUdf22() != null && (bus = busDao.findByCustNumb(guarantor.getUdf22())) != null) {
            A44 a44 = createA44(item);
        ...
        if (guarantor.getUdf29() != null && (bus = busDao.findByCustNumb(guarantor.getUdf29())) != null) {
            A44 a44 = createA44(item);
        ...
        if (guarantor.getUdf36() != null && (bus = busDao.findByCustNumb(guarantor.getUdf36())) != null) {
            A44 a44 = createA44(item);
        ...
        if (guarantor.getUdf43() != null && (bus = busDao.findByCustNumb(guarantor.getUdf43())) != null) {
            A44 a44 = createA44(item);
        ...
        if (guarantor.getUdf51() != null && (bus = busDao.findByCustNumb(guarantor.getUdf51())) != null) {
            A44 a44 = createA44(item);
        ...
        if (guarantor.getUdf58() != null && (bus = busDao.findByCustNumb(guarantor.getUdf58())) != null) {
            A44 a44 = createA44(item);
        ...
        if (guarantor.getUdf65() != null && (bus = busDao.findByCustNumb(guarantor.getUdf65())) != null) {
            A44 a44 = createA44(item);
        ...
        if (guarantor.getUdf72() != null && (bus = busDao.findByCustNumb(guarantor.getUdf72())) != null) {
            A44 a44 = createA44(item);
        ...
        if (guarantor.getUdf79() != null && (bus = busDao.findByCustNumb(guarantor.getUdf79())) != null) {
            A44 a44 = createA44(item);
        ...
        if (guarantor.getUdf86() != null && (bus = busDao.findByCustNumb(guarantor.getUdf86())) != null) {
            A44 a44 = createA44(item);
        ...
        if (guarantor.getUdf93() != null && (bus = busDao.findByCustNumb(guarantor.getUdf93())) != null) {
            A44 a44 = createA44(item);
        ...
        if (guarantor.getUdf100() != null && (bus = busDao.findByCustNumb(guarantor.getUdf100())) != null) {
            A44 a44 = createA44(item);
        ...
        if (guarantor.getUdf107() != null && (bus = busDao.findByCustNumb(guarantor.getUdf107())) != null) {
            A44 a44 = createA44(item);
