 ...
 * 
 * <p>
 * Like C's <tt>sprintf(3)</tt>, Strings may be formatted using the static
 ...
 * 
 * <p>
 * The optional <i>width</i> is a non-negative decimal integer indicating the
 ...
 * character is <tt>'t'</tt> or <tt>'T'</tt>. The second character indicates the
 ...
 * characters: <tt>char</tt>, {@link Character}, <tt>byte</tt>, {@link Byte},
 * <tt>short</tt>, and {@link Short}. This conversion may also be applied to the
 * types <tt>int</tt> and {@link Integer} when
 * {@link Character#isValidCodePoint} returns <tt>true</tt>
 * 
 * <li><b>Numeric</b>
 * 
 * <ol>
 ...
 * {@link Byte}, <tt>short</tt>, {@link Short}, <tt>int</tt> and {@link Integer}, <tt>long</tt>, {@link Long}, and {@link java.math.BigInteger BigInteger}
 * 
 ...
 * {@link Date}.
 * 
 * <li><b>Percent</b> - produces a literal <tt>'%'</tt> (<tt>'&#92;u0025'</tt>)
 * 
 ...
 * by an upper-case character (i.e. <tt>'B'</tt>, <tt>'H'</tt>, <tt>'S'</tt>,
 * <tt>'C'</tt>, <tt>'X'</tt>, <tt>'E'</tt>, <tt>'G'</tt>, <tt>'A'</tt>, and
 * <tt>'T'</tt>) are the same as those for the corresponding lower-case
 ...
 * <tt>false</tt>". If <i>arg</i> is a <tt>boolean</tt> or {@link Boolean}, then
 ...
 * is obtained by invoking <tt>arg.toString()</tt>.
 * 
 * <tr>
 ...
 * <tt>'t'</tt> and <tt>'T'</tt> conversions. The types are similar to but not
 * completely identical to those defined by GNU <tt>date</tt> and POSIX
 ...
 * <tt>00:00:00</tt> UTC, i.e. <tt>Long.MIN_VALUE</tt> to
 ...
 * month name}, e.g. <tt>"January"</tt>, <tt>"February"</tt>.
 * 
 * <tr>
 * <td valign="top"><tt>'b'</tt>
 * <td>Locale-specific {@linkplain java.text.DateFormatSymbols#getShortMonths
 * abbreviated month name}, e.g. <tt>"Jan"</tt>, <tt>"Feb"</tt>.
 * 
 * <tr>
 * <td valign="top"><tt>'h'</tt>
 * <td>Same as <tt>'b'</tt>.
 ...
 * <td>Four-digit year divided by <tt>100</tt>, formatted as two digits with
 * leading zero as necessary, i.e. <tt>00 - 99</tt>
 * 
 * <tr>
 * <td valign="top"><tt>'Y'</tt>
 * <td>Year, formatted as at least four digits with leading zeros as necessary,
 * e.g. <tt>0092</tt> equals <tt>92</tt> CE for the Gregorian calendar.
 * 
 * <tr>
 * <td valign="top"><tt>'y'</tt>
 ...
 * e.g. <tt>001 - 366</tt> for the Gregorian calendar.
 * 
 * <tr>
 * <td valign="top"><tt>'m'</tt>
 ...
 * <tr>
 * <td valign="top"><tt>'r'</tt>
 * <td>Time formatted for the 12-hour clock as <tt>"%tI:%tM:%tS %Tp"</tt>. The
 * location of the morning or afternoon marker (<tt>'%Tp'</tt>) may be
 * locale-dependent.
 * 
 * <tr>
 * <td valign="top"><tt>'D'</tt>
 ...
 * date formatted as <tt>"%tY-%tm-%td"</tt>.
 * 
 * <tr>
 * <td valign="top"><tt>'c'</tt>
 * <td>Date and time formatted as <tt>"%ta %tb %td %tT %tZ %tY"</tt>, e.g.
 ...
 * 
 * <p>
 * <sup>2</sup> For <tt>'d'</tt> conversion only.
 * 
 * <p>
 * <sup>3</sup> For <tt>'o'</tt>, <tt>'x'</tt>, and <tt>'X'</tt> conversions
 * only.
 * 
 * <p>
 * <sup>4</sup> For <tt>'d'</tt>, <tt>'o'</tt>, <tt>'x'</tt>, and <tt>'X'</tt>
 * conversions applied to {@link java.math.BigInteger BigInteger} or
 * <tt>'d'</tt> applied to <tt>byte</tt>, {@link Byte}, <tt>short</tt>,
 * {@link Short}, <tt>int</tt> and {@link Integer}, <tt>long</tt>, and
 * {@link Long}.
 * 
 * <p>
 * <sup>5</sup> For <tt>'e'</tt>, <tt>'E'</tt>, <tt>'f'</tt>, <tt>'g'</tt>, and
 * <tt>'G'</tt> conversions only.
 * 
 * <p>
 ...
 * 
 * <p>
 * For the floating-point conversions <tt>'e'</tt>, <tt>'E'</tt>, and
 ...
 * 
 * <p>
 * Another way to reference arguments by position is to use the <tt>'&lt;'</tt>
 ...
 * 
 * <p>
 * All specified exceptions may be thrown by any of the <tt>format</tt> methods
 * of <tt>Formatter</tt> as well as by any <tt>format</tt> convenience methods
 * such as {@link String#format(String,Object...) String.format} and
 * {@link java.io.PrintStream#printf(String,Object...) PrintStream.printf}.
 * 
 * <p>
 * Conversions denoted by an upper-case character (i.e. <tt>'B'</tt>,
 ...
 * {@link java.util.Locale Locale}. The result is equivalent to the following
 ...
 * 
 * <p>
 * If the argument is <tt>null</tt>, then the result is "<tt>false</tt>". If the
 * argument is a <tt>boolean</tt> or {@link Boolean}, then the result is the
 * string returned by {@link String#valueOf(boolean) String.valueOf()}.
 * Otherwise, the result is "<tt>true</tt>".
 * 
 * <p>
 * If the <tt>'#'</tt> flag is given, then a
 ...
 * 
 * <p>
 * If the argument, <i>arg</i> is <tt>null</tt>, then the result is "
 * <tt>null</tt>". Otherwise, the result is obtained by invoking
 * <tt>Integer.toHexString(arg.hashCode())</tt>.
 * 
 * <p>
 ...
 * 
 * <p>
 * If the argument is <tt>null</tt>, then the result is "<tt>null</tt>". If the
 * argument implements {@link Formattable}, then its
 * {@link Formattable#formatTo formatTo} method is invoked. Otherwise, the
 * result is obtained by invoking the argument's <tt>toString()</tt> method.
 * 
 * <p>
 * If the <tt>'#'</tt> flag is given and the argument is not a
 ...
 * then the padding will be on the right. If the width is not specified then
 * there is no minimum.
 * 
 * <p>
 ...
 * 
 * This conversion may be applied to <tt>char</tt> and {@link Character}. It may
 * also be applied to the types <tt>byte</tt>, {@link Byte}, <tt>short</tt>, and
 * {@link Short}, <tt>int</tt> and {@link Integer} when
 ...
 * href="../lang/Character.html#unicode">Unicode Character Representation</a>.
 * This may be more than one 16-bit <tt>char</tt> in the case where the argument
 ...
 * 
 * <p>
 * The <tt>'-'</tt> flag defined for <a href="#dFlags">General conversions</a>
 * applies. If the <tt>'#'</tt> flag is given, then a
 * {@link FormatFlagsConversionMismatchException} will be thrown.
 * 
 * <p>
 ...
 * 
 * <p>
 * <b><a name="l10n algorithm"> Number Localization Algorithm</a></b>
 * 
 * <p>
 ...
 * <i>z</i>; that is <i>d&nbsp;-&nbsp;</i> <tt>'0'</tt> <i>&nbsp;+&nbsp;z</i>.
 * 
 ...
 * 
 * <li>If the <tt>','</tt> (<tt>'&#92;u002c'</tt>) <a name="l10n group">flag</a>
 ...
 * defined by the locale's
 * {@linkplain java.text.DecimalFormat#getGroupingSize() grouping size}.
 * 
 * <li>If the <tt>'0'</tt> flag is given, then the locale-specific
 ...
 * 
 * <p>
 * The following conversions may be applied to <tt>byte</tt>, {@link Byte},
 ...
 * 
 * <p>
 * If the <tt>'0'</tt> flag is given and the value is negative, then the zero
 ...
 * by adding 2<sup>n</sup> to the value where <tt>n</tt> is the number of bits
 * in the type as returned by the static <tt>SIZE</tt> field in the
 * {@linkplain Byte#SIZE Byte}, {@linkplain Short#SIZE Short},
 * {@linkplain Integer#SIZE Integer}, or {@linkplain Long#SIZE Long} classes as
 * appropriate.
 * 
 * <p>
 * If the <tt>'#'</tt> flag is given then the output will always begin with the
 * radix indicator <tt>'0'</tt>.
 * 
 * <p>
 * If the <tt>'0'</tt> flag is given then the output will be padded with leading
 * zeros to the field width following any indication of sign.
 * 
 * <p>
 * If <tt>'('</tt>, <tt>'+'</tt>, '&nbsp&nbsp;', or <tt>','</tt> flags are given
 ...
 * <p>
 * If the <tt>'#'</tt> flag is given then the output will always begin with the
 * radix indicator <tt>"0x"</tt>.
 * 
 * <p>
 * If the <tt>'0'</tt> flag is given then the output will be padded to the field
 * width with leading zeros after the radix indicator or sign (if present).
 * 
 * <p>
 * If <tt>'('</tt>, <tt>'&nbsp;&nbsp;'</tt>, <tt>'+'</tt>, or <tt>','</tt> flags
 ...
 * <td>The upper-case variant of <tt>'x'</tt>. The entire string representing
 * the number will be converted to {@linkplain String#toUpperCase upper case}
 * including the <tt>'x'</tt> (if any) and all hexadecimal digits <tt>'a'</tt> -
 * <tt>'f'</tt> (<tt>'&#92;u0061'</tt> - <tt>'&#92;u0066'</tt>).
 * 
 * </table>
 * 
 * <p>
 * If the conversion is <tt>'o'</tt>, <tt>'x'</tt>, or <tt>'X'</tt> and both the
 * <tt>'#'</tt> and the <tt>'0'</tt> flags are given, then result will contain
 * the radix indicator (<tt>'0'</tt> for octal and <tt>"0x"</tt> or
 * <tt>"0X"</tt> for hexadecimal), some number of zeros (based on the width),
 * and the value.
 * 
 * <p>
 * If the <tt>'-'</tt> flag is not given, then the space padding will occur
 * before the sign.
 * 
 * <p>
 ...
 * 
 * <p>
 * If both the <tt>'+'</tt> and <tt>'&nbsp;&nbsp;'</tt> flags are given then an
 ...
 * 
 * <p>
 * If both the <tt>'-'</tt> and <tt>'0'</tt> flags are given then an
 * {@link IllegalFormatFlagsException} will be thrown.
 * 
 * <tr>
 * <td valign="top"> <tt>','</tt>
 ...
 * separators} as described in the <a href="#l10n group">"group" section</a> of
 * the localization algorithm.
 * 
 * <tr>
 * <td valign="top"> <tt>'('</tt>
 * <td valign="top"> <tt>'&#92;u0028'</tt>
 * <td>Requires the output to prepend a <tt>'('</tt> (<tt>'&#92;u0028'</tt>) and
 * append a <tt>')'</tt> (<tt>'&#92;u0029'</tt>) to negative values.
 * 
 * </table>
 * 
 * <p>
 ...
 * padding is on the left by default. If <tt>'-'</tt> flag is given then the
 ...
 * <tt>'-'</tt> (<tt>'&#92;u002d'</tt>). Signed output is allowed for this type
 ...
 * 
 * <p>
 * If <i>x</i> is positive or zero and the <tt>'+'</tt> flag is given then the
 * result will begin with <tt>'+'</tt> (<tt>'&#92;u002b'</tt>).
 * 
 * <p>
 * If the <tt>'#'</tt> flag is given then the output will always begin with
 * <tt>'0'</tt> prefix.
 * 
 * <p>
 * If the <tt>'0'</tt> flag is given then the output will be padded with leading
 ...
 * If the conversion is <tt>'o'</tt>, <tt>'x'</tt>, or <tt>'X'</tt> and both the
 * <tt>'#'</tt> and the <tt>'0'</tt> flags are given, then result will contain
 * the base indicator (<tt>'0'</tt> for octal and <tt>"0x"</tt> or <tt>"0X"</tt>
 ...
 * 
 * <p>
 * The following conversions may be applied to <tt>float</tt>, {@link Float},
 * <tt>double</tt> and {@link Double}.
 * 
 ...
 * the <a href="#l10n algorithm">localization algorithm</a>. The formatting of
 ...
 * followed by the exponent symbol <tt>'e'</tt> (<tt>'&#92;u0065'</tt>),
 * followed by the sign of the exponent, followed by a representation of
 * <i>n</i> as a decimal integer, as produced by the method
 * {@link Long#toString(long, int)}, and zero-padded to include at least two
 * digits.
 * 
 * <p>
 ...
 * the default value is <tt>6</tt>. If the precision is less than the number of
 ...
 * 
 * <p>
 * If the <tt>','</tt> flag is given, then an
 * {@link FormatFlagsConversionMismatchException} will be thrown.
 * 
 * <tr>
 * <td valign="top"> <tt>'E'</tt>
 * <td valign="top"> <tt>'&#92;u0045'</tt>
 * <td>The upper-case variant of <tt>'e'</tt>. The exponent symbol will be
 * <tt>'E'</tt> (<tt>'&#92;u0045'</tt>).
 * 
 * <tr>
 ...
 * described below. The <a href="#l10n algorithm">localization algorithm</a> is
 * applied.
 * 
 * <p>
 ...
 * 
 * <p>
 * If <i>m</i> is greater than or equal to 10<sup>-4</sup> but less than
 ...
 * If the precision is not specified, then the default value is <tt>6</tt>. If
 * the precision is <tt>0</tt>, then it is taken to be <tt>1</tt>.
 * 
 * <p>
 * If the <tt>'#'</tt> flag is given then an
 * {@link FormatFlagsConversionMismatchException} will be thrown.
 ...
 * value) of the argument. The formatting of the sign is described in the <a
 * href="#l10n algorithm">localization algorithm</a>. The formatting of the
 ...
 * with <tt>'-'</tt> (<tt>'&#92;u002d'</tt>).
 * 
 * <p>
 * If <i>x</i> is positive or a positive-zero value and the <tt>'+'</tt> flag is
 * given then the result will begin with <tt>'+'</tt> (<tt>'&#92;u002b'</tt>).
 * 
 * <p>
 * The formatting of the magnitude <i>m</i> depends upon its value.
 * 
 ...
 * <tt>"0x0.0p0"</tt>.
 * 
 * <li>If <i>m</i> is a <tt>double</tt> value with a normalized representation
 * then substrings are used to represent the significand and exponent fields.
 * The significand is represented by the characters <tt>"0x1."</tt> followed by
 * the hexadecimal representation of the rest of the significand as a fraction.
 * The exponent is represented by <tt>'p'</tt> (<tt>'&#92;u0070'</tt>) followed
 ...
 * 
 * <li>If <i>m</i> is a <tt>double</tt> value with a subnormal representation
 * then the significand is represented by the characters <tt>'0x0.'</tt>
 * followed by the hexadecimal representation of the rest of the significand as
 * a fraction. The exponent is represented by <tt>'p-1022'</tt>. Note that there
 * must be at least one nonzero digit in a subnormal significand.
 * 
 * </ul>
 * 
 * <p>
 * If the <tt>'('</tt> or <tt>','</tt> flags are given, then a
 * {@link FormatFlagsConversionMismatchException} will be thrown.
 * 
 * <tr>
 * <td valign="top"> <tt>'A'</tt>
 * <td valign="top"> <tt>'&#92;u0041'</tt>
 * <td>The upper-case variant of <tt>'a'</tt>. The entire string representing
 * the number will be converted to upper case including the <tt>'x'</tt> (
 * <tt>'&#92;u0078'</tt>) and <tt>'p'</tt> (<tt>'&#92;u0070'</tt> and all
 * hexadecimal digits <tt>'a'</tt> - <tt>'f'</tt> (<tt>'&#92;u0061'</tt> -
 * <tt>'&#92;u0066'</tt>).
 * 
 * </table>
 * 
 ...
 * 
 * <p>
 * If the <tt>'#'</tt> flag is given, then the decimal separator will always be
 * present.
 * 
 * <p>
 ...
 * width. The padding is on the left by default. If the <tt>'-'</tt> flag is
 * given then the padding will be on the right. If width is not specified then
 * there is no minimum.
 * 
 * <p>
 * If the <a name="floatDPrec">conversion</a> is <tt>'e'</tt>, <tt>'E'</tt> or
 * <tt>'f'</tt>, then the precision is the number of digits after the decimal
 * separator. If the precision is not specified, then it is assumed to be
 * <tt>6</tt>.
 * 
 * <p>
 * If the conversion is <tt>'g'</tt> or <tt>'G'</tt>, then the precision is the
 * total number of significant digits in the resulting magnitude after rounding.
 * If the precision is not specified, then the default value is <tt>6</tt>. If
 * the precision is <tt>0</tt>, then it is taken to be <tt>1</tt>.
 * 
 * <p>
 * If the conversion is <tt>'a'</tt> or <tt>'A'</tt>, then the precision is the
 * number of hexadecimal digits after the decimal separator. If the precision is
 * not provided, then all of the digits as returned by
 * {@link Double#toHexString(double)} will be output.
 * 
 * <p>
 * <a name="dndec"><b> BigDecimal </b></a>
 * 
 * <p>
 ...
 * href="#floatDPrec">precision</a> is the same as defined for Float and Double.
 * 
 * <h4><a name="ddt">Date/Time</a></h4>
 * 
 * <p>
 * This conversion may be applied to <tt>long</tt>, {@link Long},
 * {@link Calendar}, and {@link Date}.
 * 
 ...
 * <td valign="top"> <tt>'&#92;u0048'</tt>
 * <td>Hour of the day for the 24-hour clock, formatted as two digits with a
 * leading zero as necessary i.e. <tt>00 - 23</tt>. <tt>00</tt> corresponds to
 * midnight.
 * 
 * <tr>
 * <td valign="top"><tt>'I'</tt>
 ...
 * <td>Hour for the 12-hour clock, formatted as two digits with a leading zero
 * as necessary, i.e. <tt>01 - 12</tt>. <tt>01</tt> corresponds to one o'clock
 * (either morning or afternoon).
 * 
 * <tr>
 * <td valign="top"><tt>'k'</tt>
 * <td valign="top"> <tt>'&#92;u006b'</tt>
 * <td>Hour of the day for the 24-hour clock, i.e. <tt>0 - 23</tt>. <tt>0</tt>
 * corresponds to midnight.
 * 
 * <tr>
 * <td valign="top"><tt>'l'</tt>
 * <td valign="top"> <tt>'&#92;u006c'</tt>
 * <td>Hour for the 12-hour clock, i.e. <tt>1 - 12</tt>. <tt>1</tt> corresponds
 ...
 * <td>Nanosecond within the second, formatted as nine digits with leading zeros
 * as necessary, i.e. <tt>000000000 - 999999999</tt>. The precision of this
 ...
 * morning or afternoon} marker in lower case, e.g."<tt>am</tt>" or "<tt>pm</tt>
 * ". Use of the conversion prefix <tt>'T'</tt> forces this output to upper
 * case. (Note that <tt>'p'</tt> produces lower-case output. This is different
 * from GNU <tt>date</tt> and POSIX <tt>strftime(3c)</tt> which produce
 * upper-case output.)
 * 
 * <tr>
 * <td valign="top"><tt>'z'</tt>
 ...
 * <td>Milliseconds since the beginning of the epoch starting at 1 January 1970
 * <tt>00:00:00</tt> UTC, i.e. <tt>Long.MIN_VALUE</tt> to
 * <tt>Long.MAX_VALUE</tt>. The precision of this value is limited by the
 * resolution of the underlying operating system or hardware.
 * 
 * </table>
 * 
 * <p>
 ...
 * <td>Day of year, formatted as three digits with leading zeros as necessary,
 * e.g. <tt>001 - 366</tt> for the Gregorian calendar. <tt>001</tt> corresponds
 ...
 * <td>Month, formatted as two digits with leading zeros as necessary, i.e.
 * <tt>01 - 13</tt>, where "<tt>01</tt>" is the first month of the year and ("
 * <tt>13</tt>" is a special value required to support lunar calendars).
 * 
 * <tr>
 * <td valign="top"><tt>'d'</tt>
 * <td valign="top"> <tt>'&#92;u0064'</tt>
 * <td>Day of month, formatted as two digits with leading zeros as necessary,
 * i.e. <tt>01 - 31</tt>, where "<tt>01</tt>" is the first day of the month.
 * 
 * <tr>
 * <td valign="top"><tt>'e'</tt>
 * <td valign="top"> <tt>'&#92;u0065'</tt>
 ...
 * 
 * <p>
 * The <a name="dtWidth">width</a> is the minimum number of characters to be
 * written to the output. If the length of the converted value is less than the
 * <tt>width</tt> then the output will be padded by spaces (
 * <tt>'&#92;u0020'</tt>) until the total number of characters equals width. The
 * padding is on the left by default. If the <tt>'-'</tt> flag is given then the
 * padding will be on the right. If width is not specified then there is no
 * minimum.
 * 
 * <p>
 ...
 * <p>
 * The <a name="dtWidth">width</a> is the minimum number of characters to be
 * written to the output including the <tt>'%'</tt>. If the length of the
 * converted value is less than the <tt>width</tt> then the output will be
 * padded by spaces (<tt>'&#92;u0020'</tt>) until the total number of characters
 * equals width. The padding is on the left. If width is not specified then just
 * the <tt>'%'</tt> is output.
 * 
 * <p>
 * The <tt>'-'</tt> flag defined for <a href="#dFlags">General conversions</a>
 ...
 * array as defined by the <a href="http://java.sun.com/docs/books/vmspec/">Java
 * Virtual Machine Specification</a>. If the argument index is does not
 * correspond to an available argument, then a
...
public class Formatter implements Closeable, Flushable {
     ...
     * 
     * @return <tt>null</tt> if no localization is applied, otherwise a locale
     * 
    ...
    /**
     * Returns the result of invoking <tt>toString()</tt> on the destination for
     ...
     * return their contents in <tt>toString()</tt>, but streams cannot since
     * the data is discarded.
     * 
     * @return The result of invoking <tt>toString()</tt> on the destination for
     *         the output
     * 
     * @throws FormatterClosedException
     *             If this formatter has been closed by invoking its
     ...
     * {@link java.io.Flushable} interface, its <tt>flush</tt> method will be
     * invoked.
     * 
     * <p>
     ...
     * {@link java.io.Closeable} interface, its <tt>close</tt> method will be
     * invoked.
     * 
     * <p>
    ...
    /**
     * Returns the <tt>IOException</tt> last thrown by this formatter's
     * {@link Appendable}.
     * 
     * <p>
     * If the destination's <tt>append()</tt> method never throws
     ...
     *            The {@linkplain java.util.Locale locale} to apply during
     *            formatting. If <tt>l</tt> is <tt>null</tt> then no
     *            localization is applied. This does not change this object's
